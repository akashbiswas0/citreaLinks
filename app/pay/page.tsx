  ...
  return (
    <div className="min-h-screen bg-black relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-20 left-20 w-96 h-96 bg-orange-500/20 rounded-full blur-3xl animate-pulse-slow"></div>
        <div className="absolute bottom-32 right-32 w-64 h-64 bg-orange-600/30 rounded-full blur-2xl animate-float" style={{animationDelay: '2s'}}></div>
        <div className="absolute top-1/2 left-1/3 w-32 h-32 bg-orange-400/40 rounded-full blur-xl animate-bounce-gentle" style={{animationDelay: '1s'}}></div>
      </div>
      ...
      <header className="relative z-10 m-8">
        <div className="relative overflow-hidden">
          ...
          <div className="absolute inset-0 bg-gradient-to-r from-orange-900/40 via-orange/60 to-orange-800/40 rounded-[2rem]"></div>
          <div className="absolute inset-0 bg-gradient-to-r from-orange-500/20 via-transparent to-orange-600/20 rounded-[2rem] animate-pulse"></div>
          ...
          <div className="relative px-10 py-5 flex items-center justify-between">
            ...
            <div className="flex items-center gap-6">
              ...
              <div className="relative group">
                {/* Outer ring */}
                <div className="absolute inset-0 w-16 h-16 bg-gradient-to-r from-orange-400 to-orange-600 rounded-full blur-md opacity-60 group-hover:opacity-80 transition-all duration-500 animate-spin-slow"></div>
                
                {/* Main logo */}
                
                
                {/* Floating dots */}
                <div className="absolute -top-1 -right-1 w-3 h-3 bg-orange-300 rounded-full animate-bounce"></div>
                <div className="absolute -bottom-1 -left-1 w-2 h-2 bg-orange-400 rounded-full animate-bounce" style={{animationDelay: '0.5s'}}></div>
              </div>
              ...
              <div className="relative">
                ...
                <Link href="/">
                <h1 className="text-4xl font-black bg-gradient-to-r from-white via-orange-100 to-orange-200 bg-clip-text text-transparent mb-1">
                  Citrea Links
                </h1>
                </Link>    
                {/* Subtitle with animated underline */}
                <div className="flex items-center gap-3">
                  <p className="text-orange-300/90 text-sm font-medium tracking-wide">Choose Payment Link</p>
                  <div className="w-8 h-0.5 bg-gradient-to-r from-orange-400 to-transparent rounded-full animate-pulse"></div>
                </div>
                
                {/* Decorative elements */}
                <div className="absolute -bottom-2 left-0 w-full h-0.5 bg-gradient-to-r from-orange-500/50 via-orange-400/30 to-transparent rounded-full"></div>
              </div>
            </div>
            ...
            <div className="flex items-center gap-6">
              {/* Status indicator */}
              <div className="hidden sm:flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-orange-500/20 to-orange-600/20 border border-orange-500/30 rounded-full backdrop-blur-sm">
                <div className="w-2 h-2 bg-orange-400 rounded-full animate-ping"></div>
                <span className="text-orange-200 text-sm font-medium">Ready to Pay</span>
              </div>
              
              {/* Connect button */}
              <div className="relative">
                <div className="absolute inset-0 bg-gradient-to-r from-orange-500/30 to-orange-600/30 rounded-xl blur-md opacity-60"></div>
                <ConnectButton />
              </div>
            </div>
          </div>
          ...
          {/* Bottom accent line */}
          <div className="absolute bottom-0 left-8 right-8 h-0.5 bg-gradient-to-r from-transparent via-orange-500/60 to-transparent"></div>
        </div>
      </header>
      ...
      <main className="relative z-10 flex min-h-screen flex-col items-center px-8 pb-16">
        ...
        <div className="text-center mb-16 max-w-4xl">
          <div className="inline-flex items-center gap-3 px-6 py-3 bg-orange-500/10 border border-orange-500/30 rounded-full mb-8 backdrop-blur-sm">
            ...
            <span className="text-orange-200 font-semibold">Available Links</span>
          </div>
          
          <h2 className="text-5xl md:text-6xl font-black text-white mb-6 leading-tight">
            Discover
            <span className="block bg-gradient-to-r from-orange-400 via-orange-500 to-orange-600 bg-clip-text text-transparent font-pixel">
              Citrea Actions
            </span>
          </h2>
                      ...
                      <div className="space-y-4">
                        ...
                        <div className="backdrop-blur-sm bg-white/5 border border-red-500/20 rounded-2xl p-4">
                          <div className="text-red-200 text-sm flex items-center gap-3">
                            <span className="font-bold text-xl text-white">{l.amount} cBTC</span>
