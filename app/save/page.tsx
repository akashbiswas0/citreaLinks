  ...
  return (
    <div className="min-h-screen bg-black relative overflow-hidden">
      ...
      <header className="relative z-10 m-8">
        <div className="backdrop-blur-xl bg-orange-500/10 border border-orange-500/30 rounded-3xl shadow-2xl">
          <div className="px-8 py-4 flex items-center justify-between">
            ...
            <div className="flex items-center gap-5">
              ...
              <div>
                ...
                <p className="text-orange-400/80 text-sm font-medium">Create Payment Links</p>
              </div>
            </div>
      ...
      <main className="relative z-10 flex min-h-screen flex-col items-center px-8 pb-16">
        ...
        <div className="text-center mb-16 max-w-4xl">
          <div className="inline-flex items-center gap-3 px-6 py-3 bg-orange-500/10 border border-orange-500/30 rounded-full mb-8 backdrop-blur-sm">
            ...
            <span className="text-orange-200 font-semibold">AI-Powered Blockchain Links Generation</span>
          </div>
        ...
        <div className="w-full max-w-6xl">
          <form onSubmit={onSave} className="space-y-8">
            ...
            <div className="relative group">
              {/* Animated background */}
              <div className="absolute -inset-1 bg-gradient-to-r from-orange-600/30 via-orange-500/20 to-orange-700/30 rounded-2xl blur-xl group-hover:blur-2xl transition-all duration-700 opacity-0 group-hover:opacity-100"></div>
              
              {/* Main header card */}
              <div className="relative backdrop-blur-xl bg-gradient-to-br from-black/40 via-orange-950/20 to-black/40 border border-orange-500/20 rounded-2xl p-6 shadow-2xl">
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-4">
                    ...
                    <div className="relative">
                      <div className="w-20 h-20 bg-gradient-to-br from-orange-500 via-orange-600 to-orange-800 rounded-3xl flex items-center justify-center shadow-2xl group-hover:shadow-orange-500/40 transition-all duration-500">
                    ...
                    <div>
                      <h3 className="text-3xl font-bold bg-gradient-to-r from-white via-orange-100 to-orange-200 bg-clip-text text-transparent">
                        AI Payment Generator
                      </h3>
                      <p className="text-orange-300/80 text-lg">Transform your ideas into smart payment links</p>
                    </div>
                  </div>
            ...
            {/* Input Fields Card */}
            <div className="relative group">
              <div className="absolute -inset-1 bg-gradient-to-r from-orange-500/20 to-orange-600/20 rounded-2xl blur-lg group-hover:blur-xl transition-all duration-500 opacity-0 group-hover:opacity-100"></div>
              
              <div className="relative backdrop-blur-xl bg-gradient-to-br from-black/30 via-orange-950/10 to-black/30 border border-orange-500/20 rounded-2xl p-8 shadow-xl">
                
                {/* Recipient Address */}
                <div className="mb-8">
                  <label className="block text-lg font-semibold text-orange-200 mb-3 flex items-center gap-2">
                  ...
                  <div className="relative">
                    <input
                      ...
                      className="w-full backdrop-blur-sm bg-white/5 border-2 border-orange-500/20 rounded-xl px-6 py-4 text-white placeholder-orange-300/50
                                 focus:border-orange-400 focus:ring-4 focus:ring-orange-400/20 transition-all duration-300 text-lg
                                 hover:border-orange-500/30"
                    />
                    <div className="absolute right-4 top-1/2 transform -translate-y-1/2">
                      <div className="w-3 h-3 bg-orange-400/60 rounded-full animate-pulse"></div>
                    </div>
                  </div>
                </div>
                ...
                <div className="mb-8">
                  ...
                  <div className="relative">
                    <textarea
                      ...
                      className="w-full backdrop-blur-sm bg-white/5 border-2 border-orange-500/20 rounded-xl px-6 py-4 text-white placeholder-orange-300/50
                                 focus:border-orange-400 focus:ring-4 focus:ring-orange-400/20 transition-all duration-300 text-lg min-h-[140px] resize-none
                                 hover:border-orange-500/30"
                    />
                    <div className="absolute right-4 top-4">
                      <div className="w-2 h-2 bg-orange-500/60 rounded-full animate-pulse" style={{animationDelay: '0.3s'}}></div>
                    </div>
                  </div>
                </div>
                ...
                <div className="text-center">
                  <button 
                    ...
                    onClick={onGenerate} 
                    disabled={loadingGen}
                    className="group relative px-12 py-4 bg-gradient-to-r from-orange-500 via-orange-600 to-orange-700 rounded-2xl text-white font-bold text-lg
                               hover:from-orange-600 hover:via-orange-700 hover:to-orange-800 transform hover:scale-105 transition-all duration-300
                               shadow-2xl hover:shadow-orange-500/30 disabled:opacity-50 disabled:cursor-not-allowed
                  ...
                  >
                    {loadingGen ? (
                      ...
                      <>
                        ...
                        <div className="absolute inset-0 bg-gradient-to-r from-orange-500 to-orange-700 rounded-2xl blur opacity-50 -z-10 group-hover:opacity-75 transition-opacity"></div>
                      </>
                    )}
                  </button>
                </div>
              ...
              <div className="relative group">
                ...
                <div className="relative backdrop-blur-xl bg-gradient-to-br from-black/30 via-green-950/10 to-black/30 border border-green-500/20 rounded-2xl p-8 shadow-xl">
                  ...
                  {genComponentHtml ? (
                    ...
                    <div className="backdrop-blur-sm bg-white/5 border-2 border-green-500/30 rounded-2xl p-6 mb-6">
                      ...
                      <div className="text-green-200 text-lg mb-2">
                        {genAmount ? `${genAmount} cBTC` : "Amount TBD"} → {to || "recipient"}
                      </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div className="space-y-2">
                      <label className="block text-xs font-medium text-red-200">Amount (cBTC)</label>
                      <input 
                        type="number" 
                        min="0" 
                        step="0.000001" 
